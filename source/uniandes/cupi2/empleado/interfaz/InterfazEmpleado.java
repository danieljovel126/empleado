...
public class InterfazEmpleado extends JFrame
{
    ...
    /**
     * Calcula la antig�edad del empleado y la muestra.
     */
     ...
     * <b>post: </b> Se actualiz� el salario del empleado y se present� la informaci�n actualizada.
     */
    public void modificarSalario( )
    {
        ...
        if( strSalario != null )
        {
            try
            {
                ...
                if( nuevoSalario <= 0 )
                {
                    JOptionPane.showMessageDialog( this, "El salario debe ser un n�mero positivo.", "Modificar salario", JOptionPane.ERROR_MESSAGE );
                }
                else
                {
            ...
            {
                JOptionPane.showMessageDialog( this, "El salario debe ser un n�mero.", "Modificar salario", JOptionPane.ERROR_MESSAGE );
            }
        }
    }
     ...
     * <b>post: </b> Se actualizaron los campos de la ventana que contienen la informaci�n del empleado.
     */
     ...
     * @param pGenero Nuevo g�nero del empleado. pGenero == 1 && pGenero == 0.
    ...
    /**
     * Muestra el di�logo para modificar el empleado.
     */
